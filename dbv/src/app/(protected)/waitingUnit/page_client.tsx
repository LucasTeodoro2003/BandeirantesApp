    ...
    <div className="flex min-h-screen flex-col justify-center items-center p-4 text-center gap-6">
      ...
      <div className="">
        <Alert variant="destructive" className="max-w-md">
          <AlertCircleIcon />
          <AlertTitle>SOLICITE UMA UNIDADE</AlertTitle>
          <AlertDescription>
            Para continuar é necessário solicitar uma unidade ao diretor do clube. Entre em contato com o diretor para obter mais informações sobre como solicitar uma unidade e aguarde a aprovação.
          </AlertDescription>
          <AlertDescription>
